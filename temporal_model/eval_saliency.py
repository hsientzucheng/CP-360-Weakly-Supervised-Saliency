...
def parse_args():
    ...
    parser.add_argument('--input', dest='data_dir',default='../cp', help='file path', type=str)
    parser.add_argument('--gt', dest='gt_dir',default='../gt', help='gt path', type=str)
...
def main():
    ...
    for data_item in data_list:
        ...
        for data_npy in gt_path_list:
            ...
            heatmap.save(targ_dir + '/' + '{:06}.png'.format(int(data_npy.split('.')[0])))
        ...
        print(data_item+": "+str(sim/vid_tt_num)+", "+str(cc/vid_tt_num)+", "+str(auc_judd/vid_tt_num))
        
        tEnd = time.time()
        print("It takes {0} sec, for {1} frames".format(tEnd - tStart, vid_tt_num))

        all_result.append([data_item,sim/vid_tt_num,cc/vid_tt_num,auc_judd/vid_tt_num])
